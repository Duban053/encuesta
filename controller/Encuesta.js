...
const postEncuestas = async (req, res) => {
    ...
    const Encuesta1 = new encuestas({ NombreEncuesta, Fecha, DocumentoEncuestado, NombreEncuestado, Edad, Genero, Empleado })
...
const putEncuestas = async (req, res) => {
    ...
    const Encuesta1 = await encuestas.findOneAndUpdate({ DocumentoEncuestado: DocumentoEncuestado }, {
...
const patchEncuestas= async (req,res)=>{
    ...
    const Encuesta1 = await encuestas.findOneAndUpdate({ DocumentoEncuestado: DocumentoEncuestado }, {NombreEncuesta: NombreEncuesta})
...
const deleteEncuestas = async ( req,res)=>{
    ...
    const Encuesta1 = await encuestas.findOneAndDelete({DocumentoEncuestado:DocumentoEncuestado})
